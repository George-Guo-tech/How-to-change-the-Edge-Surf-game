// let ws = new WebSocket("ws://localhost:8001/peer");
// ws.onopen=()=>{console.log('成功连接')}
...
var online={};
online.visitors={};
socket.on('user-update',function(peerId,state){

    online.visitors[peerId].state=state
});

socket.on('user-disconnected',function(peerId,sockid){
    console.log('用户离开,'+'peerjs_id是'+peerId)
    delete online.visitors[peerId]
});
socket.on('user-connected',function(peerId,socketid){
    console.log('新用户链接,'+'peerjs_id是'+peerId)
    // console.log('socket.id是'+socketid)
    online.visitors[peerId]={}
    online.visitors[peerId].join='to_add'
});
...
myPeer.on('open',id =>{
    ...
    //  console.log('您已经链接,'+'3001端口的peerjs为您产生的id是'+id)
      PEERID= id
    // console.log('3000端口的socket.io为您产生的id是'+socket.id)
})
    ...
    var s = i(7)
      ...
      , l = function() {
        ...
        return t.prototype.initializeGame = function() {
            this.defineCanvas(this.canvas),//获取canvas
            this.resetStats(),//重设生命
            this.resetGame(),//背景，岛屿，物体重置
        ...
        t.prototype.updateAll = function() {
            ...
            if (h.Player.instance.isMoving) {
                this.distance += h.Player.instance.ySpeed * t.system.interval / h.Player.instance.maxSpeed;
              ...
              if (this.distance < this.winDistance - 1.5 * this.height / h.Player.instance.maxSpeed) {
                this.spawn.update();
              } else {
                if (this.distance > this.winDistance - this.height / 1.5 / h.Player.instance.maxSpeed && !this.islandspawn.isSpawned) {
                  /** @type {boolean} */
                  this.clearPath = true;
                  /** @type {boolean} */
...
//
 function 第1函数(t, e, i) {
    ...
    var r = i(0)
      ...
      , o = i(5)
      , h = i(3)
      , c = function(创建Object函数) {
        function Player函数(i, s, n) {
            var r = 创建Object函数.call(this, "Player", i, s, 64, 64, n) || this;
            return Player函数.instance ? Player函数.instance : (Player函数.instance = r,
            r.box = new o.ObjectArea(r,16,32,32,32),
            r.reset(),
            r)
        }
        return n(Player函数, 创建Object函数),
        Player函数.prototype.reset = function() {
            this.updateInterval(),
        ...
        ,
        Player函数.prototype.updateInterval = function() {
            this.accel = r.Game.system.interval / 4 * .06
        }
        ,
        Player函数.prototype.update = function() {
            this.updateInterval(),
        ...
        ,
        Player函数.prototype.updatePlayerState = function() {
        ...
        ,
        Player函数.prototype.updatePlayerFrame = function() {
            // if (this.ObjectName=="Visitor"){
            //     console.log('更新访客动作')
            // };
            switch (this.state) {
            case "stop":
        ...
        ,
        Player函数.prototype.konamiSprite = function() {
        ...
        ,
        Player函数.prototype.renderCharacterSelection = function(t) {
        ...
        ,
        Player函数.prototype.objectToNewArray = function(t, e, i) {
            var s = e.splice(t, 1)[0];
            i.push(s)
        }
        ,
        Player函数.prototype.boosting = function() {
            this.frameCounter++,
        ...
        ,
        Player函数.prototype.airborne = function() {
        ...
        ,
        Player函数.prototype.crashed = function() {
            if (this.frameCounter++,
            this.boostTimer = 0,
            this.airTimer = 0,
            this.state = "crash",
        ...
        ,
        Player函数.prototype.boost = function() {
        ...
        ,
        Player函数.prototype.jump = function() {
        ...
        ,
        Player函数.prototype.fall = function() {
            this.crashDog(),
        ...
        ,
        Player函数.prototype.slow = function() {
            this.ySpeed = .66 * this.ySpeed
        }
        ,
        Player函数.prototype.superSlow = function() {
            this.ySpeed = .5 * this.ySpeed
        }
        ,
        Player函数.prototype.spin = function() {
        ...
        ,
        Player函数.prototype.finalStretch = function() {
            this.state = "down",
            this.ySpeed = this.maxSpeed
        }
        ,
        Player函数.prototype.crashDog = function() {
            this.collectedDog && (r.Game.system.removeAllShields(),
            this.collectedDog = !1,
            a.Spawn.instance.spawnCrashedDog())
        }
        ,
        Player函数.prototype.win = function() {
            this.state = "win",
            this.draw(r.Game.system.ctx)
        }
        ,
        Player函数.prototype.lose = function() {
            this.state = "crash",
            this.draw(r.Game.system.ctx)
        }
        ,
        Player函数.prototype.loseEnemy = function() {
            this.state = "lose",
            this.draw(r.Game.system.ctx),
            this.crashDog()
        }
        ,
        Player函数.prototype.draw = function(e) {
            // if (this.ObjectName=='Visitor'){
            ...
            // socket.emit('更新滑板', Math.floor(this.x), Math.floor(this.y), this.whichFrame, this.surfboardPose),
            创建Object函数.prototype.draw.call(this, e),
...
,
//
 , function 返回sprite函数(t, e, i) {
    "use strict";
    e.__esModule = !0;
    var s = function() {
        function 画Sprite(t, e, i) {
            var s = $(t);
            this.numFrames = e,
        ...
        return 画Sprite.prototype.draw = function(t, e, i, s, n) {
            void 0 === n && (n = 0),
...
//
 , function 第3函数(t, e, i) {
    ...
    var r = i(0)
      ...
      , o = i(3)
      , h = function() {
        function 创建Object函数(t, e, i, s, n, a, o) {
            this.ObjectName = t,
        ...
        return 创建Object函数.prototype.update = function() {
        ...
        ,
        创建Object函数.prototype.reset = function() {}
        ,
        创建Object函数.prototype.move = function(t, e) {
            this.x += t,
            this.y += e,
            this.box.translateXY(t, e)
        }
        ,
        创建Object函数.prototype.draw = function(t) {
    ...
    var p = function() {
        ...
        return Object区域函数.prototype.rectOverlaps = function(t) {
            //t是障碍物      //this是路人
        ...
        ,
        Object区域函数.prototype.translateXY = function(t, e) {
            this.x = this.x + t,
            this.y = this.y + e
        }
        ,
...
, function 第6函数(t, e, i) {
    ...
    var s = i(0)
      ...
      , c = function() {
        function spawn函数() {
            if (spawn函数.instance)
                return spawn函数.instance;
            spawn函数.instance = this,
            this.reset()
        }
        return spawn函数.prototype.reset = function() {
            this.player = [],
            this.obstacles = [],
            this.surfers = [],
            this.enemies = [],
        ...
        ,
        spawn函数.prototype.update = function() {
            ...
            e >= this.nextEnemy && t < .01 * this.chance && "air" !== Player_func.Player.instance.state.substring(0, 3) && (this.spawnNewEnemy(),
            this.nextEnemy = e + this.freqEnemy)
            this.thispeerindex=0;
            if (online.visitors !={}){
                
            for (let visitorid in online.visitors){
                if (online.visitors[visitorid].join=='to_add'){
                    online.visitors[visitorid].join="added",
                    this.spawnNewVisitor(),
                 this.thispeerindex++,
    console.log('加入 visitor '+ visitorid)
        ...
        ,
        spawn函数.prototype.spawnPlayer = function(t, e) {
            this.player = new Player_func.Player(Math.floor(t / 2) - 32,Math.floor(e / 3) - 32),
            Player_func.Player.instance.reset(),
            s.Game.system.objMain.push(this.player)
        }
        ,
        spawn函数.prototype.spawnNewSurfer = function(t) {
            void 0 === t && (t = null);
            var e = 400
              , i = s.Game.system.linearMap(3, 12);
            i < Player_func.Player.instance.ySpeed && (e = s.Game.system.height),
        ...
        ,
         spawn函数.prototype.spawnNewVisitor = function(t) {
            void 0 === t && (t = null);
            var e = 400
              , i = s.Game.system.linearMap(3, 12);
            i < Player_func.Player.instance.ySpeed && (e = s.Game.system.height),
            null === t && ((t = new r.Surfer(Math.floor(Math.random() * s.Game.system.width),e)).maxSpeed = i),
            t.ObjectName='Visitor',
            t.box.x=250,
            t.box.y=250,
            t.x=250,
            t.y=250,
            ...
            t.effect='ramp',
            s.Game.system.objMain.push(t),
            // console.log('新访客'+"("+t.x+", "+t.y+")"),
            t.surferInstance = this.thispeerindex,
            t.visitor_num=this.thispeerindex,
            t.surferInstance <= 5 ? t.surfboardInstance = s.Game.system.linearMap(0, 5) : t.surfboardInstance = s.Game.system.linearMap(6, 8),
            this.surfers.push(t)
            // this.player = new Player_func.Player(250,250),
            // this.player.ObjectName='Visitor',
            // this.player.box.x=150,
            // this.player.box.y=150,
            // this.player.x=150,
            // this.player.y=150,
            // // Player_func.Player.instance.reset(),
            // s.Game.system.objMain.push(this.player)
        ...
        spawn函数.prototype.spawnNewEnemy = function(t, e, i, r) {
            void 0 === t && (t = null),
            void 0 === e && (e = 0),
            void 0 === i && (i = 0),
            void 0 === r && (r = null),
            (t = null === t ? new a.Enemy(Math.floor(Math.random() * s.Game.system.width),-118) : new a.Enemy(e,i)).currentSpeed = null === r ? Player_func.Player.instance.ySpeed + Player_func.Player.instance.maxSpeed / 2 : r,
            s.Game.system.objMain.push(t),
            this.enemies.push(t)
        }
        ,
        spawn函数.prototype.spawnNewObstacle = function(t) {
            void 0 === t && (t = null),
            null === t && (t = this.randomObstacle()),
            t.isInBack ? s.Game.system.objBack.push(t) : s.Game.system.objMain.push(t),
            this.obstacles.push(t)
//             console.log('%c ', 'font-size:400px; background:url(t.sprite.image.currentSrc) no-repeat;'),
            // ,console.log("新障碍"+t.sprite.image.id+"("+t.x+", "+t.y+")")
        }
        ,
        spawn函数.prototype.spawnPowerupRow = function() {
            for (var t = -3; t <= 4; t++) {
        ...
        ,
        spawn函数.prototype.spawnCrashedDog = function() {
            var t = new h.DogCrash64(Player_func.Player.instance.x + 24,Player_func.Player.instance.y + 24,11);
            s.Game.system.objMain.push(t),
            this.obstacles.push(t)
        }
        ,
        spawn函数.prototype.randomObstacle = function() {
            ...
            9 === c && e < this.nextCharacter || "air" === Player_func.Player.instance.state.substring(0, 3) ? c = 0 : 7 === c && (e < this.nextPowerup || "air" === Player_func.Player.instance.state.substring(0, 3)) ? c = 0 : 2 === c && e < this.nextRamp ? c = 0 : 6 === c && e < this.nextIsland ? c = 0 : 11 === c && (e < this.nextDog || Player_func.Player.instance.collectedDog) ? c = 0 : 3 === c && e < this.nextTentacle && (c = 5),
            "air" === Player_func.Player.instance.state.substring(0, 3) && r > i / 2 - 192 && r < i / 2 + 128 && (c = 4),
            c) {
            case 0:
...
//
, function 界面func(t, e, i) {
    "use strict";
    e.__esModule = !0;
    var s = i(0)
      , n = i(1)
      , r = i(12)
      , Interface函数 = function() {
        function t() {
            if (t.system)
                return t.system;
            t.system = this,
    ...
    e.Interface = Interface函数
}
, 
//
, , , function 第11函数(t, e, i) {
    "use strict";
    e.__esModule = !0;
    var s = i(0)
      , n = i(6)
      , r = i(1)
      , a = function() {
        function collision函数() {
            if (collision函数.instance)
                return collision函数.instance;
            collision函数.instance = this,
            this.reset()
        }
        return collision函数.prototype.reset = function() {
            this.clear()
        }
        ,
        collision函数.prototype.clear = function() {
            this.surfers = [],
            this.enemies = [],
            this.obstacles = []
        }
        ,
        collision函数.prototype.update = function() {
            function t(t) {
                return t.ObjectName
            }
            this.clear();
        ...
        ,
        collision函数.prototype.collisionHappened = function(t, e) {
            return t.box.rectOverlaps(e.box)
        }
        ,
        collision函数.prototype.checkCollisions = function() {
...
//                         }
                ...
                for (a = 0; a < i.length; a++) {
                    ...
                    t.boostTimer > 0 ? l.crashTimer = 1 : 
                    console.log('boostTimer的值为'+t.boostTimer+"   永不跌倒！！！")
                    //t.fall()
                    )
                }
            }
        ...
        ,
        collision函数.prototype.playerGrabbed = function(t, e) {
            t.crashTimer = 0,
            t.state = "stop",
            e.gotPlayer = !0,
            e.whichFrame = 4,
        ...
        ,
        collision函数.prototype.playerAddDog = function(t) {
            s.Game.system.addShields(),
            t.effect = null,
            t.destroy = !0
        }
        ,
        collision函数.prototype.interactAmbient = function(t) {
            t.whichPose = 0,
        ...
        ,
        collision函数.prototype.interactPowerup = function(t) {
        ...
        ,
        collision函数.prototype.interactTentacle = function(t) {
            var e = t.x - 32
              , i = t.y - 64;
        ...
        ,
        collision函数.prototype.handleCrash = function(t, e) {
            e.hitObstacle = t,
            e.crashTimer = 1
        }
        ,
        collision函数.prototype.enemyStun = function(t) {
            t.move(0, -20),
            t.crashTimer = 2,
 ...
 function 第22函数(t, e, i) {
    ...
    e.GameSetup = function() {
        var t = $("game-canvas")
          ...
          , n = function() {//在此以实现自定义效果
            requestAnimationFrame(n);
            var t = window.performance.now() - i;
            t > 1e3 / 60 && (e.gameLoop(t),//在此添加自定义效果
            i = window.performance.now())
        };
        requestAnimationFrame(n),
        function(t, e) {
...
function surfer函数(t, e, i) {
    ...
    var r = i(0)
      ...
      , h = function(t) {
        ...
        e.prototype.updatePosition = function() {
            if (this.visitor_num!=undefined)
            Object.entries(online.visitors).forEach(([visitorid,用户总状态], index) => {
            if (online.visitors[visitorid].state){
                if (this.visitor_num==index){
                    console.log('正在更新用户'+visitorid+'方向')
                this.surferAngle=online.visitors[visitorid].state
                }
            }
              });
            ...
            this.surferAngle) {
            case "left":
                this.move(.4 * -this.ySurfer, this.ySurfer);
                break;
            case "right":
                this.move(.4 * this.ySurfer, this.ySurfer)
                break;
                case "left-down":
                    this.move(.8 * -this.ySurfer, this.ySurfer);
                    break;
                case "right-down":
                    this.move(.8 * this.ySurfer, this.ySurfer)
                    break;
                    case "down":
                    this.move(0, this.ySurfer)
                    case "stop":
                    this.move(0,0)
    ...
    e.prototype.updateSprite = function() {
            if (this.visitor_num){
            // this.sprite.image.src="data:image/png;base64,"
...
if (c.isDown(c.DOWN) || c.isDown(c.S)) {
  ...
  var i = new Date;
  if (i - t <= 400) {
    r.Player.instance.boost();
    
    i = 0;
  }
  
  t = i;
  if ("air" === r.Player.instance.state.substring(0, 3)) {
    
    r.Player.instance.trick = (r.Player.instance.trick + 1) % r.Player.instance.maxTricks;
    s.Game.system.tricks += 1;
  } else {
    
    r.Player.instance.state = "down";
  }
} else
                    t = 0;
                    if (c.isDown(c.LEFT) || c.isDown(c.A)) {
                        if ("left-down" === r.Player.instance.state || "left" === r.Player.instance.state) {
                          
                          r.Player.instance.state = "left"; socket.emit('user-update', "left")
                        } else {
                          
                          r.Player.instance.state = "left-down";
                           socket.emit('user-update', "left-down")
                        }
                      } else {
                        if (c.isDown(c.RIGHT) || c.isDown(c.D)) {
                          if ("right-down" === r.Player.instance.state || "right" === r.Player.instance.state) {
                            
                            r.Player.instance.state = "right";socket.emit('user-update', "right")
                          } else {
                            
                            r.Player.instance.state = "right-down";socket.emit('user-update', "right-down")
                          }
                        } else {
                          if (c.isDown(c.UP) || c.isDown(c.W)) {
                            
                            r.Player.instance.state = "stop";socket.emit('user-update', "stop")
                          } else {
                            if (c.isDown(c.F)) {
                              r.Player.instance.boost();
                            }
            ...
            onKeydownWaiting: function(t) {
                'use strict';
                if (c.isDown(c.ENTER) || c.isDown(c.SPACE)) {
                  n.Interface.system.buildStartScreen();
                  a.Spawn.instance.spawnPowerupRow();

                  s.Game.system.gameState = "ready";
                } else {
                  if (c.isDown(c.LEFT) || c.isDown(c.A)) {
                    if (r.Player.instance.character > 0) {
                      r.Player.instance.character -= 1;
                    }
                  } else {
                    if ((c.isDown(c.RIGHT) || c.isDown(c.D)) && r.Player.instance.character < r.Player.instance.totalCharacters - 1) {
                      r.Player.instance.character += 1;
                    }
                  }
                }
